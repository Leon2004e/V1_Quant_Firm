//+------------------------------------------------------------------+
//| Strategy 6.20.168 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 01/12/2026 09:53
//| 
//|    Backtested on GBPUSD_DARWIN / M15,H1, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.20.168";
...
input int EMAPeriod3 = 22;        //EMAPeriod3
input int ATRPeriod1 = 10;        //ATRPeriod1
input double ProfitTargetCoef1 = 6.8;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.6;        //StopLossCoef1
...
#define EMA_3 2     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 6.20.168";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", "(sqGetIndicatorValue(EMA_3, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 0.5))", 0, 0, 0, 0))
      &&   (NormalizeDouble((double) sqTimeDayOfWeek(TimeCurrent()), 6) != NormalizeDouble((double) 1, 6)))
)
   {
      // Action #1
        // Enter at Market
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "(sqGetIndicatorValue(EMA_3, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 0.5))") {
          return   (sqGetIndicatorValue(EMA_3, 0, shift + 1) + (sqGetIndicatorValue(ATR_1, 0, shift + 1) * 0.5));
      }
