...
//|    Generated at 12/12/2025 14:39
//| 
//|    Backtested on GBPUSD_DARWIN / M15,H1,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.8.159";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int BollingerBandsPrd1 = 29;        //BollingerBandsPrd1
...
input double StopLoss1 = 25;        //StopLoss1
...
input string SignalTimeRangeFrom = "10:15";
input string SignalTimeRangeTo = "09:00";
...
string sqStrategyName = "Strategy 6.8.159";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 22)
)
   {
      // Action #1
        // Enter at Market
