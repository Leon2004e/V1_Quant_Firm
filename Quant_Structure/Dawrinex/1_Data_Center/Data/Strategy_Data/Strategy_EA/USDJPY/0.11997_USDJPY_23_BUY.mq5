...
//|    Generated at 01/10/2026 13:50
//| 
//|    Backtested on USDJPY_DARWIN / M15,H1, 2018.01.01 - 2026.01.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.11997";
...
input int EMAPeriod3 = 13;        //EMAPeriod3
...
string sqStrategyName = "Strategy 0.11997";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((((NormalizeDouble((double) regime_state, 6) == NormalizeDouble((double) -1, 6))
      &&   indyCrossesBelow("sqClose(NULL,0, 2)", EMA_3, 0, 2, 0, 0))
      &&   (NormalizeDouble((double) sqOpen(NULL,0, 1), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6)))
      &&   (NormalizeDouble((double) sqTimeDayOfWeek(TimeCurrent()), 6) != NormalizeDouble((double) 3, 6)))
)
   {
      // Action #1
        // Enter at Market
