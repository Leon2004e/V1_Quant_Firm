//+------------------------------------------------------------------+
//| Strategy 3.20.139 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/08/2025 13:49
//| 
//|    Backtested on USDJPY_DARWIN / M15,H1,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "1:31", "8:00")
...
string sqStrategyName = "Strategy 3.20.139";
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "1:31", "8:00");
