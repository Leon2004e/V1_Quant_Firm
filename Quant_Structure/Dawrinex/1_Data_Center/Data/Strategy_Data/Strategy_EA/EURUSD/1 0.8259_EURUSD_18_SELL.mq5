...
//|    Generated at 01/11/2026 12:14
//| 
//|    Backtested on EURUSD_DARWIN / M15,H1, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.8259";
...
input double ProfitTargetCoef1 = 6.6;        //ProfitTargetCoef1
...
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 30)
...
string sqStrategyName = "Strategy 0.8259";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) (sqGetIndicatorValue(EMA_3, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 0.3)), 6)))
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
