...
//|    Generated at 01/12/2026 10:18
//| 
//|    Backtested on USDCAD_DARWIN / M15,H1, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.10395";
...
input int BollingerBandsPrd1 = 26;        //BollingerBandsPrd1
input double ProfitTargetCoef1 = 3.2;        //ProfitTargetCoef1
...
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 15)
...
string sqStrategyName = "Strategy 0.10395";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) regime_down, 6) == NormalizeDouble((double) 1, 6))
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", BOLLINGERBANDS_1, 0, 1, 0, 1 + 1))
      &&   (NormalizeDouble((double) sqTimeDayOfWeek(TimeCurrent()), 6) != NormalizeDouble((double) 2, 6)))
)
   {
      // Action #1
        // Enter at Market
