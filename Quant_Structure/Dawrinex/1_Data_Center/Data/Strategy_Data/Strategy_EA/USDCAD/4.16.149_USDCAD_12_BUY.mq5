//+------------------------------------------------------------------+
//| Strategy 4.16.149 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/08/2025 15:28
//| 
//|    Backtested on USDCAD_DARWIN / M15,H1,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 4.16.149";
...
input double ProfitTarget1 = 95;        //ProfitTarget1
...
string sqStrategyName = "Strategy 4.16.149";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (crossesDown(RSI_1, 1, 35.0)
      &&   sqGetIndicatorValue(ADX_1, 1) < 27.0)
)
   {
      // Action #1
        // Enter at Market
