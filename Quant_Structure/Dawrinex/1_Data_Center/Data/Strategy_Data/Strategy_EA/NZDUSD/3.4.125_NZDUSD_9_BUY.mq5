...
//|    Generated at 12/09/2025 16:52
//| 
//|    Backtested on NZDUSD_DARWIN / M15,H1,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.4.125";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int BollingerBandsPrd1 = 28;        //BollingerBandsPrd1
input int ADXHigherPeriod1 = 14;        //ADXHigherPeriod1
input double ProfitTargetCoef1 = 3.3;        //ProfitTargetCoef1
...
#define ADX_1 1     //iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqADX", ADXHigherPeriod1)
...
string sqStrategyName = "Strategy 3.4.125";
