...
//|    Generated at 12/12/2025 17:22
//| 
//|    Backtested on AUDUSD_DARWIN / M15,H1,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string SignalTimeRangeTo = "05:00";
...
string sqStrategyName = "Strategy 5.6.174";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (indyCrossesAbove("sqClose(NULL,0, 0)", LOWEST_1, 0, 1, 0, 0)
      &&   sqGetIndicatorValue(ADX_1, 1) < 36.0)
)
   {
      // Action #1
        // Enter at Market
