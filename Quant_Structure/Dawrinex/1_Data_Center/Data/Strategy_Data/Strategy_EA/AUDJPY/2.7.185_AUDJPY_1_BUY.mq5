...
input string CustomComment = "Strategy 2.7.185";
...
input string SignalTimeRangeFrom = "05:15";
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "2:69", "5:00")
...
string sqStrategyName = "Strategy 2.7.185";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 1) < 32.0)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "2:69", "5:00");
