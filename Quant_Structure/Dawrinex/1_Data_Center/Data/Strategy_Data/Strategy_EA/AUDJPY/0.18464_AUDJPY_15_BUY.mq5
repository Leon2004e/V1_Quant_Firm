...
//|    Generated at 01/10/2026 12:29
//| 
//|    Backtested on AUDJPY_DARWIN / M15,H1, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.18464";
bool IndicatorLoadedWithoutError = true;
int variable1 = 0;        //variable1
int regime_D1_up = 0;        //regime_D1_up
int regime_D1_down = 0;        //regime_D1_down
...
#define HIGHESTINRANGE_1 2     //iCustom(NULL,0, "SqHighestInRange", "9:58", "14:00")
#define HEIKENASHI_1 3     //255
#define HEIKENASHI_2 4     //255
...
string sqStrategyName = "Strategy 0.18464";
...
//------------------------
  if(_sqIsBarOpen == true){
...
)
   {
      ...
      // Action #1
        regime_D1_up = (int) AssignVrbVleEntMlt1;

   } else {
      // Action #1
        regime_D1_up = (int) AssignVrbVleEntMlt2;
...
//------------------------
  if(_sqIsBarOpen == true){
...
)
   {
      ...
      // Action #1
        regime_D1_down = (int) AssignVrbVleEntMlt1;

   } else {
      // Action #1
        regime_D1_down = (int) AssignVrbVleEntMlt2;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) regime_D1_up, 6) == NormalizeDouble((double) 1, 6))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 1), 6)))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "9:58", "14:00");
