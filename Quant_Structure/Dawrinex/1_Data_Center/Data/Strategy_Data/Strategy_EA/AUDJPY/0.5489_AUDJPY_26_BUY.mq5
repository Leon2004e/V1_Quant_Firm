...
input string CustomComment = "Strategy 0.5489";
bool IndicatorLoadedWithoutError = true;
int VolaHigh = 0;        //VolaHigh
int magicnumber = 0;        //magicnumber
int VolaLow = 0;        //VolaLow
int cnt_high = 0;        //cnt_high
int cnt_low = 0;        //cnt_low
input double AssignVrbVleEntMlt1 = 0;        //AssignVrbVleEntMlt1
input int ATRPeriod1 = 200;        //ATRPeriod1
input int ATRPeriod2 = 14;        //ATRPeriod2
input double AssignVrbVleEntMlt2 = 1;        //AssignVrbVleEntMlt2
input int EMAPeriod1 = 10;        //EMAPeriod1
input double ProfitTargetCoef1 = 4.2;        //ProfitTargetCoef1
...
#define EMA_1 2     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_3 3     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 30)
...
string sqStrategyName = "Strategy 0.5489";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) > NormalizeDouble((double) (1.18 * sqGetIndicatorValue(ATR_1, 0, 1)), 6)))
)
   {
      // Action #1
        VolaHigh = (int) (cnt_high + AssignVrbVleEntMlt2);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) < NormalizeDouble((double) (0.92 * sqGetIndicatorValue(ATR_1, 0, 1)), 6)))
)
   {
      // Action #1
        VolaLow = (int) (cnt_low + AssignVrbVleEntMlt2);
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", "(sqGetIndicatorValue(EMA_1, 0, 1) + (sqGetIndicatorValue(ATR_3, 0, 1) * 0.5))", 0, 0, 0, 0))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL,0, "SqATR", ATRPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 30);
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "(sqGetIndicatorValue(EMA_1, 0, 1) + (sqGetIndicatorValue(ATR_3, 0, 1) * 0.5))") {
          return   (sqGetIndicatorValue(EMA_1, 0, shift + 1) + (sqGetIndicatorValue(ATR_3, 0, shift + 1) * 0.5));
      }
