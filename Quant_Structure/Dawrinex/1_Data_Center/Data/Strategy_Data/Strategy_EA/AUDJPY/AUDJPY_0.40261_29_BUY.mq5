...
input string CustomComment = "Strategy 0.40261";
...
input int BBWidthRatioPeriod1 = 20;        //BBWidthRatioPeriod1
input int EMAPeriod3 = 15;        //EMAPeriod3
input int ATRPeriod1 = 14;        //ATRPeriod1
input double ProfitTargetCoef1 = 5.5;        //ProfitTargetCoef1
...
#define BBWIDTHRATIO_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqBBWidthRatio", BBWidthRatioPeriod1, 2, PRICE_CLOSE)
#define EMA_3 3     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 5     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 0.40261";
...
//------------------------
  if(_sqIsBarOpen == true){
   ...
   if(  (sqIsRising(EMA_1, 2, false, 1 + 1, 0))
...
//------------------------
  if(_sqIsBarOpen == true){
   ...
   if(  (NormalizeDouble((double) sqGetIndicatorValue(BBWIDTHRATIO_1, 0, 1), 6) > NormalizeDouble((double) 0.1, 6))
)
   {
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", "(sqGetIndicatorValue(EMA_3, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 0.1))", 0, 0, 0, 0))
      &&   (NormalizeDouble((double) sqTimeDayOfWeek(TimeCurrent()), 6) != NormalizeDouble((double) 4, 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BBWIDTHRATIO_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqBBWidthRatio", BBWidthRatioPeriod1, 2, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "(sqGetIndicatorValue(EMA_3, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 0.1))") {
          return   (sqGetIndicatorValue(EMA_3, 0, shift + 1) + (sqGetIndicatorValue(ATR_1, 0, shift + 1) * 0.1));
      }
