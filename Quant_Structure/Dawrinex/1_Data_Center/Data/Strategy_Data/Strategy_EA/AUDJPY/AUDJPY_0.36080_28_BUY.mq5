...
//|    Generated at 01/20/2026 15:32
//| 
//|    Backtested on AUDJPY_DARWIN / M15,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.36080";
...
input int EMAPeriod2 = 100;        //EMAPeriod2
input int ATRPeriod1 = 100;        //ATRPeriod1
input int EMAPeriod3 = 14;        //EMAPeriod3
input int ATRPeriod2 = 14;        //ATRPeriod2
input double ProfitTargetCoef1 = 4.4;        //ProfitTargetCoef1
...
#define ATR_2 4     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define ATR_3 5     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 0.36080";
...
//------------------------
  if(_sqIsBarOpen == true){
   ...
   if(  (sqIsFalling(EMA_2, 2, false, 1 + 1, 0))
...
//------------------------
  if(_sqIsBarOpen == true){
   ...
   if(  (NormalizeDouble((double) (sqHigh(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 1) - sqLow(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 1)), 6) > NormalizeDouble((double) (1.1 * sqGetIndicatorValue(ATR_1, 0, 1)), 6))
)
   {
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) vola_state, 6) == NormalizeDouble((double) 0, 6)))
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", "(sqGetIndicatorValue(EMA_3, 0, 1) + (sqGetIndicatorValue(ATR_2, 0, 1) * 0.1))", 0, 0, 0, 0))
      &&   (NormalizeDouble((double) sqTimeDayOfWeek(TimeCurrent()), 6) != NormalizeDouble((double) 5, 6)))
)
   {
      // Action #1
        // Enter at Market
