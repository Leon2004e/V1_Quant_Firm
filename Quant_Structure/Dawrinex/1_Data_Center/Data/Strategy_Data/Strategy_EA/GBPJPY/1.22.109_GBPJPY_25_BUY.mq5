//+------------------------------------------------------------------+
//| Strategy 1.22.109 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 01/14/2026 17:57
//| 
//|    Backtested on GBPJPY_DARWIN / M15,H4, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 1.22.109";
bool IndicatorLoadedWithoutError = true;
double low_on = 0.9;        //low_on
double low_off = 1;        //low_off
double high_on = 1.2;        //high_on
double high_off = 1.05;        //high_off
int VolaHigh = 0;        //VolaHigh
int VolaLow = 0;        //VolaLow
input int MagicNumber = 0;        //MagicNumber
input int ATRPeriod1 = 250;        //ATRPeriod1
...
input int RSIPeriod1 = 12;        //RSIPeriod1
input double ProfitTarget1 = 125;        //ProfitTarget1
input double TrailingStopCoef1 = 3.1;        //TrailingStopCoef1
...
input string SignalTimeRangeFrom = "11:00";
...
#define ATR_1 0     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1)
#define ATR_2 1     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod2)
#define RSI_1 2     //iRSI(NULL,0, RSIPeriod1, PRICE_CLOSE)
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 145)
...
string sqStrategyName = "Strategy 1.22.109";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) VolaHigh, 6) == NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) > NormalizeDouble((double) (high_on * sqGetIndicatorValue(ATR_1, 0, 1)), 6)))
)
   {
      // Action #1
        VolaHigh = (int) AssignVrbVleEntMlt1;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) VolaHigh, 6) == NormalizeDouble((double) 1, 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) < NormalizeDouble((double) (high_off * sqGetIndicatorValue(ATR_1, 0, 1)), 6)))
)
   {
      // Action #1
        VolaHigh = (int) AssignVrbVleEntMlt2;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((((NormalizeDouble((double) VolaHigh, 6) == NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) VolaLow, 6) == NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) < NormalizeDouble((double) (low_on * sqGetIndicatorValue(ATR_1, 0, 1)), 6)))
)
   {
      // Action #1
        VolaLow = (int) AssignVrbVleEntMlt1;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) VolaLow, 6) == NormalizeDouble((double) 1, 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) > NormalizeDouble((double) (low_off * sqGetIndicatorValue(ATR_1, 0, 1)), 6)))
)
   {
      // Action #1
        VolaLow = (int) AssignVrbVleEntMlt2;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) VolaLow, 6) == NormalizeDouble((double) 1, 6))
      &&   (sqGetIndicatorValue(RSI_1, 1)>45))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 145);
