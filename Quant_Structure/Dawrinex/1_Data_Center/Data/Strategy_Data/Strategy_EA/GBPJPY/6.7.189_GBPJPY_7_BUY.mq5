...
input string CustomComment = "Strategy 6.7.189";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int BollingerBandsPrd1 = 13;        //BollingerBandsPrd1
...
string sqStrategyName = "Strategy 6.7.189";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 1) < 25.0)
)
   {
      // Action #1
        // Enter at Market
