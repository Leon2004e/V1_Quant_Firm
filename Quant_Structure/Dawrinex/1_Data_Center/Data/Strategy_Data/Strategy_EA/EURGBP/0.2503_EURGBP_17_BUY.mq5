...
//|    Generated at 01/12/2026 09:08
//| 
//|    Backtested on EURGBP_DARWIN / M15,H1, 2018.01.01 - 2023.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.2503";
bool IndicatorLoadedWithoutError = true;
input int variable1 = 0;        //variable1
int regime_state = 0;        //regime_state
int up_cnt = 0;        //up_cnt
int down_cnt = 0;        //down_cnt
int hold_cnt = 0;        //hold_cnt
int trans_cnt = 0;        //trans_cnt
int regime_transition = 0;        //regime_transition
input double AssignVrbVleEntMlt1 = 1;        //AssignVrbVleEntMlt1
input double AssignVrbVleEntMlt2 = 0;        //AssignVrbVleEntMlt2
input int EMAPeriod1 = 30;        //EMAPeriod1
input int EMAPeriod2 = 90;        //EMAPeriod2
input int ATRPeriod1 = 14;        //ATRPeriod1
input double AssignVrbVleEntMlt3 = -1;        //AssignVrbVleEntMlt3
input int EMAPeriod3 = 17;        //EMAPeriod3
...
input string SignalTimeRangeTo = "11:00";
...
#define EMA_1 0     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define EMA_2 1     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1)
#define EMA_3 3     //iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 0.2503";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (NormalizeDouble((double) trans_cnt, 6) > NormalizeDouble((double) 0, 6))
)
   {
      // Action #1
        trans_cnt = (int) (trans_cnt - AssignVrbVleEntMlt1);
...
//------------------------
  if(_sqIsBarOpen == true){
   ...
   if(  (NormalizeDouble((double) trans_cnt, 6) > NormalizeDouble((double) 0, 6))
)
   {
      
      // Action #1
        regime_state = (int) AssignVrbVleEntMlt1;

   } else {
      // Action #1
        regime_transition = (int) AssignVrbVleEntMlt2;
...
//------------------------
// Rule: confirm_up_counter
//------------------------
  if(_sqIsBarOpen == true){

   if(  ((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6))
      &&   (NormalizeDouble((double) (sqGetIndicatorValue(EMA_1, 0, 1) - sqGetIndicatorValue(EMA_2, 0, 1)), 6) >= NormalizeDouble((double) (sqGetIndicatorValue(ATR_1, 0, 1) * 0.3), 6)))
)
   {
      
      // Action #1
        up_cnt = (int) (up_cnt + AssignVrbVleEntMlt1);

   } else {
      // Action #1
        up_cnt = (int) AssignVrbVleEntMlt2;
...
//------------------------
// Rule: confirm_down_counter
//------------------------
  if(_sqIsBarOpen == true){

   if(  ((NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6))
      &&   (NormalizeDouble((double) (sqGetIndicatorValue(EMA_2, 0, 1) - sqGetIndicatorValue(EMA_1, 0, 1)), 6) >= NormalizeDouble((double) (sqGetIndicatorValue(ATR_1, 0, 1) * 0.3), 6)))
)
   {
      
      // Action #1
        down_cnt = (int) (down_cnt + AssignVrbVleEntMlt1);

   } else {
      // Action #1
        down_cnt = (int) AssignVrbVleEntMlt2;
...
//------------------------
  if(_sqIsBarOpen == true){
   ...
   if(  (NormalizeDouble((double) regime_state, 6) != NormalizeDouble((double) 0, 6))
)
   {
      
      // Action #1
        hold_cnt = (int) (hold_cnt + AssignVrbVleEntMlt1);

   } else {
      // Action #1
        hold_cnt = (int) AssignVrbVleEntMlt2;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) regime_state, 6) == NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) up_cnt, 6) >= NormalizeDouble((double) 2, 6)))
)
   {
      // Action #1
        regime_state = (int) AssignVrbVleEntMlt1;
      ...
      // Action #3
        trans_cnt = (int) AssignVrbVleEntMlt1;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) regime_state, 6) == NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) down_cnt, 6) >= NormalizeDouble((double) 2, 6)))
)
   {
      // Action #1
        regime_state = (int) AssignVrbVleEntMlt3;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) regime_state, 6) == NormalizeDouble((double) 1, 6))
      &&   (NormalizeDouble((double) hold_cnt, 6) >= NormalizeDouble((double) 3, 6)))
      &&   (NormalizeDouble((double) down_cnt, 6) >= NormalizeDouble((double) 2, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) regime_state, 6) == NormalizeDouble((double) -1, 6))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_3, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqOpen(NULL,0, 1), 6) > NormalizeDouble((double) sqClose(NULL,0, 1), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_2] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_3] = iMA(NULL,0, EMAPeriod3, 0, MODE_EMA, PRICE_CLOSE);
