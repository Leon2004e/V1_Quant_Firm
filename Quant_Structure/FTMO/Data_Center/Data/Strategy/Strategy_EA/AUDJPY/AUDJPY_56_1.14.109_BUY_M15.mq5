//+------------------------------------------------------------------+
//| Strategy 1.14.109 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/19/2026 08:54
//| 
//|    Backtested on FTMO_AUDJPY_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 1.14.109";
...
input double ProfitTargetCoef1 = 7.3;        //ProfitTargetCoef1
input double StopLossCoef1 = 6.7;        //StopLossCoef1
...
#define PARABOLICSAR_1 3     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.2)
#define HIGHESTINRANGE_1 4     //iCustom(NULL,0, "SqHighestInRange", "18:00", "14:00")
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 20)
#define ATR_2 6     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 1.14.109";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   indyCrossesBelow("sqClose(NULL,0, 1)", EMA_3, 0, 1, 0, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 1), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "18:00", "14:00");
