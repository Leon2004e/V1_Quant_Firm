//+------------------------------------------------------------------+
//| Strategy 6.30.171 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/14/2026 11:51
//| 
//|    Backtested on FTMO_AUDJPY_M15 / M15,H4, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_6_30_171";
...
input int WPRChangesPeriod1 = 196;        //WPRChangesPeriod1
input int SMMAPeriod1 = 30;        //SMMAPeriod1
input int WPRChangesPeriod2 = 154;        //WPRChangesPeriod2
input int BPPeriod1 = 13;        //BPPeriod1
input int HullMovingAvrPrd1 = 23;        //HullMovingAvrPrd1
input int SMMAPeriod2 = 20;        //SMMAPeriod2
input int SMMAPeriod3 = 51;        //SMMAPeriod3
input double ProfitTarget1 = 30;        //ProfitTarget1
input double StopLoss1 = 30;        //StopLoss1
input double ProfitTargetCoef1 = 1.6;        //ProfitTargetCoef1
input double StopLoss2 = 50;        //StopLoss2
...
#define WILLIAMSPR_1 0     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqWPR", WPRChangesPeriod1)
#define SMMA_1 1     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define PARABOLICSAR_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqParabolicSAR", 0.02, 0.4)
#define WILLIAMSPR_2 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqWPR", WPRChangesPeriod2)
#define BEARSPOWER_1 4     //iCustom(NULL,0, "SqBearsPower", BPPeriod1, PRICE_LOW)
#define HULLMOVINGAVERAGE_1 5     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_CLOSE)
#define SMMA_2 6     //iMA(NULL,0, SMMAPeriod2, 0, MODE_SMMA, PRICE_CLOSE)
#define FIBO_1 7     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqFibo", 1, 0, -61.8, 0)
#define SMMA_3 8     //iMA(NULL,0, SMMAPeriod3, 0, MODE_SMMA, PRICE_LOW)
#define ATR_1 9     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 6.30.171";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesUp(WILLIAMSPR_1, 1)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 2), 6)));

     ShortEntrySignal = (((changesUp(WILLIAMSPR_2, 2)
      &&   sqGetIndicatorValue(BEARSPOWER_1, 3) > 0.0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMMA_2, 0, 2), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(FIBO_1, 0, 0), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMMA_3, 0, 3), 6)));
...
bool initIndicators(){
   ...
   indicatorHandles[WILLIAMSPR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqWPR", WPRChangesPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_1] = iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqParabolicSAR", 0.02, 0.4);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[WILLIAMSPR_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqWPR", WPRChangesPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", BPPeriod1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HULLMOVINGAVERAGE_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_2] = iMA(NULL,0, SMMAPeriod2, 0, MODE_SMMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FIBO_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqFibo", 1, 0, -61.8, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_3] = iMA(NULL,0, SMMAPeriod3, 0, MODE_SMMA, PRICE_LOW);
