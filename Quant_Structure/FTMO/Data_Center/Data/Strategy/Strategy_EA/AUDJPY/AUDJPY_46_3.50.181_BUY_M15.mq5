...
input string CustomComment = "Strategy_3_50_181";
...
input int BarClsSprTrnATRPrd1 = 480;        //BarClsSprTrnATRPrd1
...
input int IchimokuKjnSenCrsBshSnkPrd1 = 55;        //IchimokuKjnSenCrsBshSnkPrd1
...
#define SUPERTREND_1 0     //iCustom(NULL,0, "SqSuperTrend", 1, BarClsSprTrnATRPrd1,1.0)
...
string sqStrategyName = "Strategy 3.50.181";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 0) > sqGetIndicatorValue(SUPERTREND_1, 0))
      &&   sqIchimokuKijunSenCross(1, NULL,0, ICHIMOKU_1, 1, 2));
...
bool initIndicators(){
   ...
   indicatorHandles[SUPERTREND_1] = iCustom(NULL,0, "SqSuperTrend", 1, BarClsSprTrnATRPrd1,1.0);
