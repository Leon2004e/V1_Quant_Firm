//+------------------------------------------------------------------+
//| Strategy 3.19.102 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/16/2025 16:36
//| 
//|    Backtested on FTMO_AUDJPY_M15 / M15,H1,H4, 2021.07.14 - 2024.05.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.19.102";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 46;        //EMAPeriod1
input double ProfitTargetCoef1 = 4.5;        //ProfitTargetCoef1
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "1:69", "5:00")
...
string sqStrategyName = "Strategy 3.19.102";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((indyCrossesBelow("sqClose(NULL,0, 1)", HIGHESTINRANGE_1, 0, 1, 0, 0)
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "1:69", "5:00");
