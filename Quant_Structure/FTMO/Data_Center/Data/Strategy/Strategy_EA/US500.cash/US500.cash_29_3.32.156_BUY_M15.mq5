//+------------------------------------------------------------------+
//| Strategy 3.32.156 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/20/2025 14:47
//| 
//|    Backtested on FTMO_SP500_M15 / M15,H1,H4, 2021.01.21 - 2024.06.30 
//+------------------------------------------------------------------+
...
#define ADX_1 2     //iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqADX", ADXHigherPeriod1)
...
string sqStrategyName = "Strategy 3.32.156";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) (sqGetIndicatorValue(EMA_1, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 0.25)), 6))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqADX", ADXHigherPeriod1);
