//+------------------------------------------------------------------+
//| Strategy 2.67.165 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/26/2026 13:37
//| 
//|    Backtested on FTMO_SP500_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 2.67.165";
...
input int MTATRPeriod1 = 161;        //MTATRPeriod1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBerPeriod1, 0, 2.0, PRICE_CLOSE)
#define SMMA_1 2     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 2.67.165";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   ((sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1+1)<sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMMA_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 3), 6))))
)
   {
      // Action #1
        // Enter at Market
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 3,   (sqHigh(NULL,0, 1) + (2.30 * sqGetIndicatorValue(MTATR_1, 0, 1)))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBerPeriod1, 0, 2.0, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("(sqHigh(NULL,0, 1) + (2.30 * sqGetIndicatorValue(MTATR_1, 0, 1)))")) {
      return ((sqHigh(NULL,0, 1) + (2.30 * sqGetIndicatorValue(MTATR_1, 0, 1))));
   }
