//+------------------------------------------------------------------+
//| Strategy 6.52.179 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/24/2026 11:04
//| 
//|    Backtested on FTMO_GBPUSD_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.52.179";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 30;        //Period1
input int SuperTrendATRPeriod1 = 66;        //SuperTrendATRPeriod1
input int SuperTrendATRPeriod2 = 10;        //SuperTrendATRPeriod2
input double ProfitTargetCoef1 = 5.4;        //ProfitTargetCoef1
...
#define SUPERTREND_1 1     //iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod1,7.2)
#define SUPERTREND_2 2     //iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod2,8.8)
...
string sqStrategyName = "Strategy 6.52.179";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 2), 6))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SUPERTREND_1] = iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod1,7.2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SUPERTREND_2] = iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod2,8.8);
