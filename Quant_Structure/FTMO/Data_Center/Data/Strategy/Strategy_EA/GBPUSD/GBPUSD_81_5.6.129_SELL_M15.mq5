...
input string CustomComment = "Strategy 5.6.129";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 183;        //EMAPeriod1
input int ATRPeriod1 = 14;        //ATRPeriod1
input int MTATRPeriod1 = 114;        //MTATRPeriod1
input int ATRPeriod2 = 164;        //ATRPeriod2
input double StopLossCoef1 = 3.3;        //StopLossCoef1
...
#define KELTNERCHANNEL_1 4     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.0)
...
string sqStrategyName = "Strategy 5.6.129";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(MTATR_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6)))
)
   {
      // Action #1
        // Enter at Market
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 3,             sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 3)), "Current");
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 3)")) {
      return (sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 3));
   }
