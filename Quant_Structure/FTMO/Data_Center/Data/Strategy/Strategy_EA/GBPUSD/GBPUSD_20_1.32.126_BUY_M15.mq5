//+------------------------------------------------------------------+
//| Strategy 1.32.126 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 11/15/2025 10:46
//| 
//|    Backtested on FTMO_GBPUSD_M15 / M15,H1,H4, 2021.07.02 - 2025.11.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 1.32.126";
...
input int MACDFast1 = 12;        //MACDFast1
input int MACDSlow1 = 25;        //MACDSlow1
...
input string SignalTimeRangeFrom = "00:15";
...
#define MACD_1 1     //iMACD(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MACDFast1, MACDSlow1, MACDSmooth1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.32.126";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (sqIsRising(MACD_1, 2, false, 1 + 1, 0)))
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 17.0)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MACDFast1, MACDSlow1, MACDSmooth1, PRICE_CLOSE);
