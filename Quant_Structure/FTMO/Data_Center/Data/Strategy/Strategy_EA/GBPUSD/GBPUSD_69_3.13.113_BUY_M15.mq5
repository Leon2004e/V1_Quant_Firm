...
input string CustomComment = "Strategy 3.13.113";
...
input int HullMovingAvrPrd1 = 120;        //HullMovingAvrPrd1
input double ProfitTargetCoef1 = 2.5;        //ProfitTargetCoef1
input double TrailingStopCoef1 = 2.3;        //TrailingStopCoef1
...
#define LWMA_1 1     //iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_OPEN)
#define HULLMOVINGAVERAGE_1 2     //iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_MEDIAN)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 85)
...
string sqStrategyName = "Strategy 3.13.113";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(CCI_1, 1)>166.0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 2), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HULLMOVINGAVERAGE_1] = iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_MEDIAN);
