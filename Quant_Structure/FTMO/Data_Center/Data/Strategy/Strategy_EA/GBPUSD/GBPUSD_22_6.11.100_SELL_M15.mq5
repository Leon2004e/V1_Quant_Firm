//+------------------------------------------------------------------+
//| Strategy 6.11.100 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/18/2025 17:04
//| 
//|    Backtested on FTMO_GBPUSD_M15 / M15,H1,H4, 2021.07.02 - 2024.06.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.11.100";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 51;        //EMAPeriod1
...
#define LOWESTINRANGE_1 0     //iCustom(NULL,0, "SqLowestInRange", "2:37", "8:00")
...
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 10)
...
string sqStrategyName = "Strategy 6.11.100";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (indyCrossesAbove("sqClose(NULL,0, 1)", LOWESTINRANGE_1, 0, 1, 0, 0)
      &&   (sqIsRising(EMA_1, 2, false, 1 + 1, 0)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "2:37", "8:00");
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 10);
