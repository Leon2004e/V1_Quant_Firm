...
//|    Generated at 12/02/2025 16:00
//| 
//|    Backtested on FTMO_GBPUSD_M15 / M15,H1,H4, 2021.07.13 - 2024.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.3.167";
...
input double StopLossCoef1 = 5.5;        //StopLossCoef1
...
#define ADX_1 0     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXLowerPeriod1)
...
string sqStrategyName = "Strategy 3.3.167";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (sqGetIndicatorValue(ADX_1, 1) < 26.0
