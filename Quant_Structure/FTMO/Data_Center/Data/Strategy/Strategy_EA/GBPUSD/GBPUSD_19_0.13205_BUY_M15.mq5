...
//|    Generated at 10/10/2025 12:31
//| 
//|    Backtested on FTMO_GBPUSD_M15 / M15,H1,H4, 2021.07.15 - 2025.10.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.13205";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 110;        //EMAPeriod1
input int BollingerBandsPrd1 = 19;        //BollingerBandsPrd1
input int ADXLowerPeriod1 = 14;        //ADXLowerPeriod1
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE)
#define ADX_1 2     //iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqADX", ADXLowerPeriod1)
...
string sqStrategyName = "Strategy 0.13205";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 1) < 31.0)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqADX", ADXLowerPeriod1);
