...
input string CustomComment = "Strategy_5_35_116";
...
input int BBBarClosesPeriod2 = 188;        //BBBarClosesPeriod2
input double ProfitTargetCoef1 = 4.9;        //ProfitTargetCoef1
input double StopLoss1 = 95;        //StopLoss1
...
#define BOLLINGERBANDS_1 0     //iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BBBarClosesPeriod1, 0, 2.1, PRICE_OPEN)
#define VORTEX_1 1     //iCustom(NULL,0, "SqVortex", VortexChangesTrnPrd1)
#define BOLLINGERBANDS_2 2     //iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BBBarClosesPeriod2, 0, 2.3, PRICE_HIGH)
...
string sqStrategyName = "Strategy 5.35.116";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqClose(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3))
      &&   (sqGetIndicatorValue(VORTEX_1, 0, 1) < sqGetIndicatorValue(VORTEX_1, 1, 1))&&(sqGetIndicatorValue(VORTEX_1, 0, 1+1) > sqGetIndicatorValue(VORTEX_1, 1, 1+1)))
      &&   (sqClose(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 1) < sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1)));
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BBBarClosesPeriod1, 0, 2.1, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[VORTEX_1] = iCustom(NULL,0, "SqVortex", VortexChangesTrnPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BBBarClosesPeriod2, 0, 2.3, PRICE_HIGH);
