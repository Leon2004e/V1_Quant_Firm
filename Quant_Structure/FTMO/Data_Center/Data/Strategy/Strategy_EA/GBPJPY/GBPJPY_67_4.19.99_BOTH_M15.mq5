...
input string CustomComment = "Strategy_4_19_99";
...
input int ROCPeriod1 = 10;        //ROCPeriod1
input int ATRPeriod1 = 59;        //ATRPeriod1
input int SMAPeriod3 = 20;        //SMAPeriod3
...
input int ATRPeriod2 = 20;        //ATRPeriod2
...
#define RSI_1 0     //iRSI(NULL,0, RSIPeriod1, PRICE_OPEN)
...
#define SMA_2 4     //iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define ROC_1 5     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqROC", ROCPeriod1)
#define ATR_1 6     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define TRUERANGE_1 7     //iCustom(NULL,0, "SqTrueRange");
#define SMA_3 8     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE)
#define LWMA_1 9     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
#define ATR_2 10     //iCustom(NULL,0, "SqATR", ATRPeriod2)
...
string sqStrategyName = "Strategy 4.19.99";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 3), 6))
      &&   sqIsFalling(ROC_1, 2, false, 3))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(TRUERANGE_1, 0, 3), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_3, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 2), 6)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Limit
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 3) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 2))), "Current");     
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_LIMIT, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_LIMIT, openPrice, 3,             sqGetIndicatorValue(LWMA_2, 0, 3)), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[RSI_1] = iRSI(NULL,0, RSIPeriod1, PRICE_OPEN);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_2] = iMA(NULL,0, SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_3] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), SMAPeriod3, 0, MODE_SMA, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("sqGetIndicatorValue(LWMA_2, 0, 3)")) {
      return (sqGetIndicatorValue(LWMA_2, 0, 3));
   }
   if(idHash == sqStringHash("StopLoss1")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), StopLoss1));
   }
