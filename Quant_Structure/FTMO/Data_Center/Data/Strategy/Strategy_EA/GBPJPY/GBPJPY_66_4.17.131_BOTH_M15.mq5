//+------------------------------------------------------------------+
//| Strategy 4.17.131 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/18/2026 14:30
//| 
//|    Backtested on FTMO_GBPJPY_M15 / M15,H4, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_17_131";
...
input int RSIPeriod1 = 109;        //RSIPeriod1
input int SMAPeriod1 = 40;        //SMAPeriod1
input int LinearRegressionPrd1 = 14;        //LinearRegressionPrd1
input int Period1 = 80;        //Period1
input int ROCPeriod1 = 100;        //ROCPeriod1
input int EMAPeriod1 = 30;        //EMAPeriod1
input int TEMAPeriod1 = 20;        //TEMAPeriod1
input int SMAPeriod2 = 14;        //SMAPeriod2
input int LWMAPeriod1 = 14;        //LWMAPeriod1
input double ProfitTarget1 = 85;        //ProfitTarget1
input double StopLoss1 = 100;        //StopLoss1
input int IchimokuTenkanPrd1 = 190;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 26;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 31;        //IchimokuSenkouPrd1
input int LWMAPeriod2 = 30;        //LWMAPeriod2
...
#define RSI_1 0     //iRSI(NULL,0, RSIPeriod1, PRICE_LOW)
#define SMA_1 1     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define LINEARREGRESSION_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period1, PRICE_MEDIAN)
#define PARABOLICSAR_1 4     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.20)
#define ROC_1 5     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqROC", ROCPeriod1)
#define EMA_1 6     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define TEMA_1 7     //iTEMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), TEMAPeriod1, 0, PRICE_MEDIAN)
#define SMA_2 8     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE)
#define LWMA_1 9     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
#define ICHIMOKU_1 10     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1)
#define LWMA_2 11     //iMA(NULL,0, LWMAPeriod2, 0, MODE_LWMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 4.17.131";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(RSI_1, 2, false, 1)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 3), 6)));

     ShortEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 1), 6))
      &&   sqIsFalling(ROC_1, 2, false, 3))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(TEMA_1, 0, 2), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMA_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 3), 6)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_LIMIT, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_LIMIT, openPrice, 3,             sqGetIndicatorValue(LWMA_2, 0, 2)), "Current");
      size = sqMMRiskFixedAccountPct("Current",ORDER_TYPE_SELL_LIMIT,openPrice,sl,mmRiskPercent,mmDecimals,mmStopLossPips,mmLotsIfNoMM,mmMaxLots,mmMultiplier,mmStep);
...
bool initIndicators(){
   ...
   indicatorHandles[RSI_1] = iRSI(NULL,0, RSIPeriod1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ROC_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqROC", ROCPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), TEMAPeriod1, 0, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_2] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), SMAPeriod2, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_1] = iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_2] = iMA(NULL,0, LWMAPeriod2, 0, MODE_LWMA, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("sqGetIndicatorValue(LWMA_2, 0, 2)")) {
      return (sqGetIndicatorValue(LWMA_2, 0, 2));
   }
   if(idHash == sqStringHash("StopLoss1")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), StopLoss1));
   }
