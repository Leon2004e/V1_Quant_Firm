...
//|    Generated at 03/26/2026 16:16
//| 
//|    Backtested on FTMO_GBPJPY_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.9.165";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 11;        //Period1
input int LWMAPeriod1 = 50;        //LWMAPeriod1
input int GannHiLoPeriod1 = 25;        //GannHiLoPeriod1
input double ProfitTargetCoef1 = 2.7;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.5;        //StopLossCoef1
...
#define LWMA_1 1     //iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 3.9.165";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(GANNHILO_1, 0, 3), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_1] = iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_MEDIAN);
