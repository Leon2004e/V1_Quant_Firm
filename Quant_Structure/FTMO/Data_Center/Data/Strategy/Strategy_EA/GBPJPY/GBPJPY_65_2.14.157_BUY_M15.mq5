...
input string CustomComment = "Strategy 2.14.157";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 7;        //Period1
input int CloseVWAPVWAPPeriod1 = 159;        //CloseVWAPVWAPPeriod1
input int MTATRPeriod1 = 153;        //MTATRPeriod1
input int ATRPeriod1 = 144;        //ATRPeriod1
...
string sqStrategyName = "Strategy 2.14.157";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   ((sqClose("NULL",0, 2) > sqGetIndicatorValue(VWAP_1,2))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(MTATR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 2), 6))))
)
   {
      // Action #1
        // Enter at Market
