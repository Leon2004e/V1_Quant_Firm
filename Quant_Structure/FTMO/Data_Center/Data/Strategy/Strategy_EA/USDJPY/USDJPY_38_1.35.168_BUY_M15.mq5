//+------------------------------------------------------------------+
//| Strategy 1.35.168 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 10/05/2025 17:12
//| 
//|    Backtested on FTMO_USDJPY_M15 / M15,H1, 2020.01.02 - 2025.07.09 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 1.35.168";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 52;        //EMAPeriod1
input int EMAPeriod2 = 80;        //EMAPeriod2
input int ADXHigherPeriod1 = 14;        //ADXHigherPeriod1
input int ADXRisingPeriod1 = 14;        //ADXRisingPeriod1
...
#define ADX_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXHigherPeriod1)
#define ADX_2 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXRisingPeriod1)
#define BOLLINGERBANDS_1 4     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.35.168";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6))
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 20.0)
      &&   sqIsRising(ADX_2, 2, false, 1))
      &&   indyCrossesAbove("sqClose(NULL,0, 1)", BOLLINGERBANDS_1, 0, 1, 0, 0 + 1))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXHigherPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXRisingPeriod1);
