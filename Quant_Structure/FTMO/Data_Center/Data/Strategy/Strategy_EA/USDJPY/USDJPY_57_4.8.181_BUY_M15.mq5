...
//|    Generated at 03/17/2026 12:59
//| 
//|    Backtested on FTMO_USDJPY_M15 / M15,H8, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_8_181";
...
input int ATRPeriod1 = 17;        //ATRPeriod1
input int MABarOpensPeriod1 = 25;        //MABarOpensPeriod1
input int ADXChangesDownPrd1 = 14;        //ADXChangesDownPrd1
input int MABarOpensPeriod2 = 14;        //MABarOpensPeriod2
input double ProfitTarget1 = 135;        //ProfitTarget1
...
#define TRUERANGE_1 1     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqTrueRange");
#define MOVINGAVERAGE_1 2     //iMA(NULL,0, MABarOpensPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define ADX_1 3     //iCustom(NULL,0, "SqADX", ADXChangesDownPrd1)
#define MOVINGAVERAGE_2 4     //iMA(NULL,0, MABarOpensPeriod2, 0, MODE_EMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 4.8.181";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(TRUERANGE_1, 0, 3), 6))
      &&   (sqOpen("NULL",0, 2) > sqGetIndicatorValue(MOVINGAVERAGE_1, 2+1)))
      &&   changesDown(ADX_1, 1, 0))
      &&   (sqOpen("NULL",0, 2) > sqGetIndicatorValue(MOVINGAVERAGE_2, 2+1)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", ADXChangesDownPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_2] = iMA(NULL,0, MABarOpensPeriod2, 0, MODE_EMA, PRICE_CLOSE);
