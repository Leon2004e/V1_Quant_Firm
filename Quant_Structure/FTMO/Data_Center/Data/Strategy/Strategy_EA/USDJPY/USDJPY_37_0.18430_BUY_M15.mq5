...
//|    Generated at 11/12/2025 12:51
//| 
//|    Backtested on FTMO_USDJPY_M15 / M15,H1, 2020.01.02 - 2025.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.18430";
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "3:00", "6:03")
...
string sqStrategyName = "Strategy 0.18430";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 1) < 26)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "3:00", "6:03");
