...
input string CustomComment = "Strategy_6_47_153";
...
input int VWAPVWAPPeriod1 = 137;        //VWAPVWAPPeriod1
input int OSMAFastEMA1 = 12;        //OSMAFastEMA1
input int OSMASlowEMA1 = 52;        //OSMASlowEMA1
input int OSMASignalPeriod1 = 9;        //OSMASignalPeriod1
input int MABarClosesPeriod1 = 30;        //MABarClosesPeriod1
input int ATRPeriod1 = 143;        //ATRPeriod1
input int ATRPeriod2 = 17;        //ATRPeriod2
input int IchimokuKmoBrkBshTnkPrd1 = 63;        //IchimokuKmoBrkBshTnkPrd1
...
input int LinearRegressionPrd2 = 13;        //LinearRegressionPrd2
input int Period2 = 14;        //Period2
input double ProfitTargetCoef1 = 6.2;        //ProfitTargetCoef1
input double StopLoss1 = 55;        //StopLoss1
input double ProfitTarget1 = 175;        //ProfitTarget1
input double StopLoss2 = 10;        //StopLoss2
...
#define OSMA_1 2     //iOsMA(NULL,0, OSMAFastEMA1, OSMASlowEMA1, OSMASignalPeriod1, PRICE_CLOSE)
#define MOVINGAVERAGE_1 3     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
#define LAGUERRERSI_1 4     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLaguerreRSI", 0.2)
#define ATR_1 5     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1)
#define ATR_2 6     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod2)
#define ICHIMOKU_1 7     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqIchimoku", IchimokuKmoBrkBshTnkPrd1, IchimokuKmoBrkBshKjnPrd1, IchimokuKmoBrkBshSnkPrd1)
#define LOWEST_1 8     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
#define LINEARREGRESSION_1 9     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
#define LINEARREGRESSION_2 10     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd2, PRICE_CLOSE)
#define LOWEST_2 11     //iCustom(NULL,0, "SqLowest", Period2, PRICE_WEIGHTED)
#define ATR_3 12     //iCustom(NULL, 0, "SqATR", 20)
#define HEIKENASHI_1 13     //255
#define HEIKENASHI_2 14     //255
...
string sqStrategyName = "Strategy 6.47.153";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(VWAP_1, 0, 1), 6))
      &&   sqGetIndicatorValue(OSMA_1, 0, 3, true) > 0)
      &&   (sqClose("NULL",0, 1) > sqGetIndicatorValue(MOVINGAVERAGE_1, 1)))
      &&   sqIsFalling(LAGUERRERSI_1, 2, false, 3));

     ShortEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 2), 6))
      &&   sqIchimokuKumoBreakout(-1, correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), ICHIMOKU_1, 1))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 3), 6)));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[OSMA_1] = iOsMA(NULL,0, OSMAFastEMA1, OSMASlowEMA1, OSMASignalPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LAGUERRERSI_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLaguerreRSI", 0.2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqIchimoku", IchimokuKmoBrkBshTnkPrd1, IchimokuKmoBrkBshKjnPrd1, IchimokuKmoBrkBshSnkPrd1);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_2] = iCustom(NULL,0, "SqLinReg", LinearRegressionPrd2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", Period2, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 20);
