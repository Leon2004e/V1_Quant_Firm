...
//|    Generated at 10/16/2025 12:39
//| 
//|    Backtested on FTMO_USDCHF_M15 / M15,H1,H4, 2021.07.15 - 2025.10.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.1.133";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 104;        //EMAPeriod1
input double ProfitTargetCoef1 = 2.8;        //ProfitTargetCoef1
...
#define HIGHESTINRANGE_1 1     //iCustom(NULL,0, "SqHighestInRange", "1:48", "5:00")
...
string sqStrategyName = "Strategy 3.1.133";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   indyCrossesAbove("sqClose(NULL,0, 1)", HIGHESTINRANGE_1, 0, 1, 0, 0))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "1:48", "5:00");
