//+------------------------------------------------------------------+
//| Strategy 6.37.145 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/26/2026 17:35
//| 
//|    Backtested on FTMO_USDCHF_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.37.145";
...
input int LWMAPeriod1 = 20;        //LWMAPeriod1
...
#define LOWESTINRANGE_1 1     //iCustom(NULL,0, "SqLowestInRange", "2:00", "18:30")
#define LOWEST_2 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_TYPICAL)
#define LWMA_1 3     //iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
#define PARABOLICSAR_1 4     //iCustom(NULL,0, "SqParabolicSAR", 0.03, 0.4)
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 6.37.145";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(CCI_1, 0, 1), 6) <= NormalizeDouble((double) -124.0, 6))
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 2), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 3), 6))))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "2:00", "18:30");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", Period1, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_1] = iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.03, 0.4);
