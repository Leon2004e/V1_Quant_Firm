...
//|    Generated at 11/28/2025 19:41
//| 
//|    Backtested on FTMO_USDCHF_M15 / M15,H1,H4, 2021.07.13 - 2024.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 4.5.112";
bool IndicatorLoadedWithoutError = true;
input int variable1 = 0;        //variable1
input int BollingerBandsPrd1 = 23;        //BollingerBandsPrd1
input int ADXLowerPeriod1 = 14;        //ADXLowerPeriod1
input double ProfitTargetCoef1 = 3.7;        //ProfitTargetCoef1
input double StopLossCoef1 = 6.6;        //StopLossCoef1
...
#define ADX_1 1     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXLowerPeriod1)
...
string sqStrategyName = "Strategy 4.5.112";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 1) < 30.0)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXLowerPeriod1);
