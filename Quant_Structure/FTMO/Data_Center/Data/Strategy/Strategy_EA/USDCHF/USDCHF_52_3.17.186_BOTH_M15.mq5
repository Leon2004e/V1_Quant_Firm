//+------------------------------------------------------------------+
//| Strategy 3.17.186 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/13/2026 18:58
//| 
//|    Backtested on FTMO_USDCHF_M15 / M15,H4, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_17_186";
...
input int HullMovingAvrPrd2 = 120;        //HullMovingAvrPrd2
input int SuperTrendATRPeriod1 = 35;        //SuperTrendATRPeriod1
input int SuperTrendATRPeriod2 = 24;        //SuperTrendATRPeriod2
input int BarOpensPeriod1 = 20;        //BarOpensPeriod1
input int ReflexPeriod1 = 12;        //ReflexPeriod1
input int Period2 = 30;        //Period2
input double ProfitTargetCoef1 = 2.9;        //ProfitTargetCoef1
input double StopLoss1 = 75;        //StopLoss1
input double ProfitTarget1 = 110;        //ProfitTarget1
input double StopLoss2 = 20;        //StopLoss2
...
#define LWMA_1 0     //iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_OPEN)
#define HULLMOVINGAVERAGE_1 1     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_TYPICAL)
#define HIGHEST_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period1, PRICE_TYPICAL)
#define HULLMOVINGAVERAGE_2 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHullMovingAverage", HullMovingAvrPrd2, 2.0, PRICE_OPEN)
#define SUPERTREND_1 4     //iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod1,4.7)
#define SUPERTREND_2 5     //iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod2,1.3)
#define LOWEST_1 6     //iCustom(NULL,0, "SqLowest", BarOpensPeriod1, PRICE_OPEN)
#define REFLEX_1 7     //iCustom(NULL,0, "SqReflex", ReflexPeriod1)
#define PARABOLICSAR_1 8     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqParabolicSAR", 0.01, 0.10)
#define HIGHEST_2 9     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period2, PRICE_CLOSE)
#define ATR_1 10     //iCustom(NULL, 0, "SqATR", 15)
#define HEIKENASHI_1 11     //255
#define HEIKENASHI_2 12     //255
...
string sqStrategyName = "Strategy 3.17.186";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_2, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SUPERTREND_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(SUPERTREND_2, 0, 2), 6)))
      &&   (sqOpen("NULL",0, 2+1) > sqGetIndicatorValue(LOWEST_1, 0, 2+1, true) && sqOpen("NULL",0, 2) < sqGetIndicatorValue(LOWEST_1, 0, 2+1, true)));

     ShortEntrySignal = ((sqGetIndicatorValue(REFLEX_1, 2) > sqGetIndicatorValue(REFLEX_1, 2+1))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_2, 0, 2), 6)));
...
bool initIndicators(){
   ...
   indicatorHandles[LWMA_1] = iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HULLMOVINGAVERAGE_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period1, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HULLMOVINGAVERAGE_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHullMovingAverage", HullMovingAvrPrd2, 2.0, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SUPERTREND_1] = iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod1,4.7);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SUPERTREND_2] = iCustom(NULL,0, "SqSuperTrend", 1, SuperTrendATRPeriod2,1.3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", BarOpensPeriod1, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[REFLEX_1] = iCustom(NULL,0, "SqReflex", ReflexPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqParabolicSAR", 0.01, 0.10);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period2, PRICE_CLOSE);
