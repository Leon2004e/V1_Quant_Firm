...
input string CustomComment = "Strategy 6.23.134";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 48;        //Period1
input int VortexPeriod1 = 24;        //VortexPeriod1
input int StdDevRisingPeriod1 = 98;        //StdDevRisingPeriod1
input double ProfitTargetCoef1 = 3.6;        //ProfitTargetCoef1
input double StopLossCoef1 = 7.3;        //StopLossCoef1
...
#define STDDEV_1 2     //iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 6.23.134";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (sqGetIndicatorValue(VORTEX_1, 0, 1) > sqGetIndicatorValue(VORTEX_1, 1, 1)
      &&   sqIsRising(STDDEV_1, 2, false, 1)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_TYPICAL);
