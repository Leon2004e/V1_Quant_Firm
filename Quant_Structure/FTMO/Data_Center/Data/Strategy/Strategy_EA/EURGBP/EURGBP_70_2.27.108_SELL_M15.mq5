//+------------------------------------------------------------------+
//| Strategy 2.27.108 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/23/2026 19:46
//| 
//|    Backtested on FTMO_EURGBP_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 2.27.108";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 47;        //EMAPeriod1
input int ATRPeriod1 = 14;        //ATRPeriod1
input int UlcerIndexeePeriod1 = 20;        //UlcerIndexeePeriod1
...
#define ULCERINDEX_1 2     //iCustom(NULL,0, "SqUlcerIndex", 1,UlcerIndexeePeriod1)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 15)
...
string sqStrategyName = "Strategy 2.27.108";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqSafeDivide((sqClose(NULL,0, 1) - sqGetIndicatorValue(EMA_1, 0, 1)), sqGetIndicatorValue(ATR_1, 0, 1)), 6) >= NormalizeDouble((double) 2, 6))
      &&   (sqGetIndicatorValue(ULCERINDEX_1, 1)<0.07))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ULCERINDEX_1] = iCustom(NULL,0, "SqUlcerIndex", 1,UlcerIndexeePeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 25);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 15);
