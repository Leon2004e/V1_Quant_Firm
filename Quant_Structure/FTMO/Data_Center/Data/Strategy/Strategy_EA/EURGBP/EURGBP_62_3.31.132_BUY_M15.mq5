...
#define LOWESTINRANGE_1 1     //iCustom(NULL,0, "SqLowestInRange", "10:30", "16:30")
#define LOWESTINRANGE_2 2     //iCustom(NULL,0, "SqLowestInRange", "14:00", "13:00")
...
string sqStrategyName = "Strategy 3.31.132";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_2, 0, 2), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "10:30", "16:30");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_2] = iCustom(NULL,0, "SqLowestInRange", "14:00", "13:00");
