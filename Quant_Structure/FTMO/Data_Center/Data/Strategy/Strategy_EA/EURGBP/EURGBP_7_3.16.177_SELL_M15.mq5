//+------------------------------------------------------------------+
//| Strategy 3.16.177 EA
//|
//|    Generated by StrategyQuant X Build 142 for AlgoCloud
//|    Generated at 11/14/2025 17:00
//| 
//|    Backtested on FTMO_EURGBP_M15 / M15,H1, 2021.07.15 - 2025.11.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.16.177";
...
input int ADXHigherPeriod1 = 18;        //ADXHigherPeriod1
input double ProfitTargetCoef1 = 2;        //ProfitTargetCoef1
...
string sqStrategyName = "Strategy 3.16.177";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 20)
)
   {
      // Action #1
        // Enter at Market
