//+------------------------------------------------------------------+
//| Strategy 2.36.141 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/15/2026 09:03
//| 
//|    Backtested on FTMO_EURGBP_M15 / M15,H1, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_36_141";
...
input int LinearRegressionPrd1 = 64;        //LinearRegressionPrd1
input int IchimokuTenkanPrd1 = 9;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 107;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 175;        //IchimokuSenkouPrd1
input int LinearRegressionPrd2 = 16;        //LinearRegressionPrd2
input int IchimokuTenkanPrd2 = 137;        //IchimokuTenkanPrd2
input int IchimokuKijunPeriod2 = 71;        //IchimokuKijunPeriod2
input int IchimokuSenkouPrd2 = 52;        //IchimokuSenkouPrd2
input int LinearRegressionPrd3 = 13;        //LinearRegressionPrd3
input int EMAPeriod1 = 50;        //EMAPeriod1
input int MAPeriod1 = 48;        //MAPeriod1
input double ProfitTargetCoef1 = 1.1;        //ProfitTargetCoef1
input double StopLossCoef1 = 5.9;        //StopLossCoef1
input double ProfitTargetCoef2 = 8.2;        //ProfitTargetCoef2
...
#define LINEARREGRESSION_1 0     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
#define ICHIMOKU_1 1     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1)
#define LINEARREGRESSION_2 2     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd2, PRICE_TYPICAL)
#define ICHIMOKU_2 3     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd2, IchimokuKijunPeriod2, IchimokuSenkouPrd2)
#define FRACTAL_1 4     //iCustom(NULL,0, "SqFractal", 3)
#define LINEARREGRESSION_3 5     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd3, PRICE_CLOSE)
#define PARABOLICSAR_1 6     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.20)
#define EMA_1 7     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_TYPICAL)
#define MOVINGAVERAGE_1 8     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define ATR_1 9     //iCustom(NULL, 0, "SqATR", 15)
#define ATR_2 10     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 2.36.141";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(ICHIMOKU_1, 1, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_2, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(ICHIMOKU_2, 3, 2), 6)));

     ShortEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(FRACTAL_1, 0, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_3, 0, 1), 6))
      &&   sqGetIndicatorValue(FRACTAL_1, 1, 3) > 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6)))
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_2] = iCustom(NULL,0, "SqLinReg", LinearRegressionPrd2, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_2] = iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd2, IchimokuKijunPeriod2, IchimokuSenkouPrd2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[FRACTAL_1] = iCustom(NULL,0, "SqFractal", 3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_3] = iCustom(NULL,0, "SqLinReg", LinearRegressionPrd3, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MAPeriod1, 0, MODE_SMMA, PRICE_CLOSE);
