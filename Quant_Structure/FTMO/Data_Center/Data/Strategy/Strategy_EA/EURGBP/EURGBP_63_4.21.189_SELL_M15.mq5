...
input string CustomComment = "Strategy 4.21.189";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int RSIPeriod1 = 14;        //RSIPeriod1
input int ATRPeriod1 = 171;        //ATRPeriod1
input int ATRPeriod2 = 182;        //ATRPeriod2
...
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 4.21.189";
