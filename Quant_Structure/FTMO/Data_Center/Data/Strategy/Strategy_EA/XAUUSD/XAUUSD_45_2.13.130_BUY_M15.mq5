//+------------------------------------------------------------------+
//| Strategy 2.13.130 EA
//|
//|    Generated by StrategyQuant X Build 142 for AlgoCloud
//|    Generated at 12/04/2025 17:00
//| 
//|    Backtested on FTMO_XAUUSD_M15 / M15,H1,H4, 2021.07.15 - 2024.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 2.13.130";
...
input double ProfitTarget1 = 1140;        //ProfitTarget1
input double StopLoss1 = 1155;        //StopLoss1
...
string sqStrategyName = "Strategy 2.13.130";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((crossesUp(RSI_1, 1, 61.0)
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 15.0)
