...
//|    Generated at 03/17/2026 11:22
//| 
//|    Backtested on FTMO_XAUUSD_M15 / M15,H8, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_5_6_136";
...
input int DIPlusPeriod1 = 14;        //DIPlusPeriod1
input int ATRFallingPeriod1 = 40;        //ATRFallingPeriod1
input int StdDevRisingPeriod1 = 14;        //StdDevRisingPeriod1
input int Period1 = 14;        //Period1
input double ProfitTarget1 = 1020;        //ProfitTarget1
input double StopLoss1 = 1000;        //StopLoss1
input double ProfitTarget2 = 660;        //ProfitTarget2
...
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRFallingPeriod1)
#define STDDEV_1 2     //iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define LOWESTINRANGE_1 3     //iCustom(NULL,0, "SqLowestInRange", "17:00", "20:00")
#define LOWEST_2 4     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLowest", Period1, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 5.6.136";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(ADX_1, 1, 3) > sqGetIndicatorValue(ADX_1, 2, 3, 1)
      &&   sqIsFalling(ATR_1, 2, false, 3));

     ShortEntrySignal = (sqIsRising(STDDEV_1, 2, false, 3)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6)));
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 1, ProfitTarget2), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "17:00", "20:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLowest", Period1, PRICE_WEIGHTED);
