//+------------------------------------------------------------------+
//| Strategy 1.25.121 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/05/2025 10:31
//| 
//|    Backtested on FTMO_US_CRUDE_M15 / M15,H1,H4, 2021.07.15 - 2024.08.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 1.25.121";
...
input double ProfitTarget1 = 550;        //ProfitTarget1
input double StopLossCoef1 = 4.8;        //StopLossCoef1
...
input double Subchart2TickSizeSQ = 0.001; //Subchart2PipSizeSQ
...
string sqStrategyName = "Strategy 1.25.121";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((crossesDown(RSI_1, 1, 50.0)
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 18.0)
