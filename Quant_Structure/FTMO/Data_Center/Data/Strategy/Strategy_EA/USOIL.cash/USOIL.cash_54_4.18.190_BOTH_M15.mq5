//+------------------------------------------------------------------+
//| Strategy 4.18.190 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/14/2026 05:57
//| 
//|    Backtested on FTMO_US_CRUDE_M15 / M15,H4, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_18_190";
...
input int KAMAERPeriod1 = 5;        //KAMAERPeriod1
input int KAMAShortPeriod1 = 87;        //KAMAShortPeriod1
input int KAMALongPeriod1 = 29;        //KAMALongPeriod1
input int StochFastKKPeriod1 = 14;        //StochFastKKPeriod1
input int StochFastKDPeriod1 = 169;        //StochFastKDPeriod1
input int StochFastKSlowing1 = 39;        //StochFastKSlowing1
input int MTKeltnerChannelPrd1 = 113;        //MTKeltnerChannelPrd1
input int LinearRegressionPrd1 = 14;        //LinearRegressionPrd1
input int BollingerBandsPrd1 = 14;        //BollingerBandsPrd1
input int BollingerBandsPrd2 = 20;        //BollingerBandsPrd2
input int EMAPeriod1 = 50;        //EMAPeriod1
input int KAMAERPeriod2 = 200;        //KAMAERPeriod2
input int KAMAShortPeriod2 = 177;        //KAMAShortPeriod2
input int KAMALongPeriod2 = 143;        //KAMALongPeriod2
input double ProfitTarget1 = 495;        //ProfitTarget1
input double StopLoss1 = 470;        //StopLoss1
input double ProfitTargetCoef1 = 5.8;        //ProfitTargetCoef1
input double StopLoss2 = 85;        //StopLoss2
...
input double Subchart1TickSizeSQ = 0.001; //Subchart1PipSizeSQ
...
#define KAMA_1 0     //iCustom(NULL,0, "SqKAMA", KAMAERPeriod1, KAMAShortPeriod1, KAMALongPeriod1)
#define STOCHASTIC_1 1     //iCustom(NULL,0, "SqStochastic", StochFastKKPeriod1, StochFastKDPeriod1, StochFastKSlowing1, MODE_SMMA, STO_CLOSECLOSE)
#define MTKELTNERCHANNEL_1 2     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.25)
#define LINEARREGRESSION_1 3     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
#define BOLLINGERBANDS_1 4     //iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BollingerBandsPrd1, 0, 1.0, PRICE_CLOSE)
#define HIGHESTINRANGE_1 5     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighestInRange", "12:30", "7:00")
#define BOLLINGERBANDS_2 6     //iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BollingerBandsPrd2, 0, 1.2, PRICE_CLOSE)
#define EMA_1 7     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_TYPICAL)
#define KAMA_2 8     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqKAMA", KAMAERPeriod2, KAMAShortPeriod2, KAMALongPeriod2)
#define ATR_1 9     //iCustom(NULL, 0, "SqATR", 30)
#define HEIKENASHI_1 10     //255
#define HEIKENASHI_2 11     //255
...
string sqStrategyName = "Strategy 4.18.190";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(KAMA_1, 0, 1+1)>sqGetIndicatorValue(KAMA_1, 0, 1)
      &&   (sqGetIndicatorValue(STOCHASTIC_1, 0, 2)>sqGetIndicatorValue(STOCHASTIC_1, 1, 2)));

     ShortEntrySignal = ((((NormalizeDouble((double) sqGetIndicatorValue(MTKELTNERCHANNEL_1, 1, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 3), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 1), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_2, 1 + 1, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 2), 6)))
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 1, StopLoss2), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STOCHASTIC_1] = iCustom(NULL,0, "SqStochastic", StochFastKKPeriod1, StochFastKDPeriod1, StochFastKSlowing1, MODE_SMMA, STO_CLOSECLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BollingerBandsPrd1, 0, 1.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighestInRange", "12:30", "7:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), BollingerBandsPrd2, 0, 1.2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KAMA_2] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqKAMA", KAMAERPeriod2, KAMAShortPeriod2, KAMALongPeriod2);
