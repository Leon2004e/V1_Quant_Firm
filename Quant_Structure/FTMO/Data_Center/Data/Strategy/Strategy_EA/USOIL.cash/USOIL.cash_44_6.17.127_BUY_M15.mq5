//+------------------------------------------------------------------+
//| Strategy 6.17.127 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/13/2025 11:10
//| 
//|    Backtested on FTMO_US_CRUDE_M15 / M15,H1,H4, 2021.07.15 - 2024.05.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.17.127";
...
input double ProfitTarget1 = 635;        //ProfitTarget1
input double StopLoss1 = 625;        //StopLoss1
...
#define ADX_1 1     //iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqADX", ADXLowerPeriod1)
...
string sqStrategyName = "Strategy 6.17.127";
