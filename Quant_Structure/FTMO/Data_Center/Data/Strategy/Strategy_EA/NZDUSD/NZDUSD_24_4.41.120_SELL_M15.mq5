//+------------------------------------------------------------------+
//| Strategy 4.41.120 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/01/2025 14:23
//| 
//|    Backtested on FTMO_NZDUSD_M15 / M15,H1,H4, 2021.07.13 - 2024.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 4.41.120";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int MACDMainCrossZroFst1 = 12;        //MACDMainCrossZroFst1
input int MACDMainCrossZroSlw1 = 20;        //MACDMainCrossZroSlw1
input int MACDMainCrossZroSmt1 = 9;        //MACDMainCrossZroSmt1
input int ADXHigherPeriod1 = 14;        //ADXHigherPeriod1
input double ProfitTargetCoef1 = 5.1;        //ProfitTargetCoef1
input double TrailingStopCoef1 = 1.1;        //TrailingStopCoef1
...
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 200)
...
string sqStrategyName = "Strategy 4.41.120";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (crossesUp(MACD_1, 1, 0, 0)
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 22.0)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 200);
