...
input string CustomComment = "Strategy 5.7.105";
...
input double StopLossCoef1 = 6.3;        //StopLossCoef1
...
string sqStrategyName = "Strategy 5.7.105";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 21.0)
)
   {
      // Action #1
        // Enter at Market
