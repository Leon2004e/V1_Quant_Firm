//+------------------------------------------------------------------+
//| Strategy 6.16.107 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 12/16/2025 22:02
//| 
//|    Backtested on FTMO_NZDUSD_M15 / M15,H1,H4, 2021.07.14 - 2024.05.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.16.107";
...
input int MACDSlow1 = 22;        //MACDSlow1
...
#define MACD_1 1     //iMACD(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), MACDFast1, MACDSlow1, MACDSmooth1, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 15)
#define HEIKENASHI_1 3     //255
#define HEIKENASHI_2 4     //255
#define HEIKENASHI_3 5     //255
...
string sqStrategyName = "Strategy 6.16.107";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((indyCrossesBelow("sqClose(NULL,0, 0)", HIGHEST_1, 0, 1, 0, 0)
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), MACDFast1, MACDSlow1, MACDSmooth1, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqClose(NULL,0, 0)") {
          return   sqClose(NULL,0, shift + 0);
      }
