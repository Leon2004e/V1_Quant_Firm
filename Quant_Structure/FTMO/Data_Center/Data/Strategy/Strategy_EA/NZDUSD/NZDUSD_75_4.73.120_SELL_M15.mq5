...
#define PARABOLICSAR_1 1     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.20)
#define HIGHESTINRANGE_1 2     //iCustom(NULL,0, "SqHighestInRange", "23:00", "16:00")
#define WILLIAMSPR_1 3     //iCustom(NULL,0, "SqWPR", WPRPeriod1)
...
string sqStrategyName = "Strategy 4.73.120";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqIsGreaterCount("sqGetIndicatorValue(RSI_1, 0, 1)","65.0",2,false,1))
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 2), 6))
      &&   sqIsFalling(WILLIAMSPR_1, 2, false, 2)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "23:00", "16:00");
