...
input string CustomComment = "Strategy 3.6.161";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int SimpleLqdSwpPrd1 = 20;        //SimpleLqdSwpPrd1
input int EMAPeriod1 = 30;        //EMAPeriod1
input int VWAPVWAPPeriod1 = 127;        //VWAPVWAPPeriod1
input int WPRPeriod1 = 40;        //WPRPeriod1
input double ProfitTargetCoef1 = 7.7;        //ProfitTargetCoef1
input double TrailingStopCoef1 = 1.4;        //TrailingStopCoef1
...
#define SIMPLELIQUIDITYSWEEP_1 1     //iCustom(NULL,0,"SqSimpleLiquiditySweep",SimpleLqdSwpPrd1,0.3,35)
#define EMA_1 2     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_MEDIAN)
#define VWAP_1 3     //iCustom(NULL,0, "SqVWAP", VWAPVWAPPeriod1)
#define WILLIAMSPR_1 4     //iCustom(NULL,0, "SqWPR", WPRPeriod1)
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_2 6     //iCustom(NULL, 0, "SqATR", 185)
...
string sqStrategyName = "Strategy 3.6.161";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (((NormalizeDouble((double) sqGetIndicatorValue(SIMPLELIQUIDITYSWEEP_1, 0, 1), 6) > NormalizeDouble((double) -893469090, 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(VWAP_1, 0, 3), 6)))
      &&   sqGetIndicatorValue(WILLIAMSPR_1, 2) > -10.0))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SIMPLELIQUIDITYSWEEP_1] = iCustom(NULL,0,"SqSimpleLiquiditySweep",SimpleLqdSwpPrd1,0.3,35);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[WILLIAMSPR_1] = iCustom(NULL,0, "SqWPR", WPRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 185);
