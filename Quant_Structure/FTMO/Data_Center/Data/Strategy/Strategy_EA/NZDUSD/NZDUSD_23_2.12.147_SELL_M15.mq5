//+------------------------------------------------------------------+
//| Strategy 2.12.147 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 10/08/2025 19:47
//| 
//|    Backtested on FTMO_NZDUSD_M15 / M15,H1,H4, 2021.07.15 - 2025.10.07 
//+------------------------------------------------------------------+
...
#define ADX_1 1     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXHigherPeriod1)
...
string sqStrategyName = "Strategy 2.12.147";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 18)
