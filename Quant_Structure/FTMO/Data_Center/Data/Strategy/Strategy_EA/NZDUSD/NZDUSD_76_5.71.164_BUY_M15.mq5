...
input string CustomComment = "Strategy 5.71.164";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int ATRPeriod1 = 198;        //ATRPeriod1
input int ATRPeriod2 = 163;        //ATRPeriod2
input int LinRegBarOpensPrd1 = 14;        //LinRegBarOpensPrd1
input int ATRPeriod3 = 162;        //ATRPeriod3
input int ATRPeriod4 = 52;        //ATRPeriod4
input double ProfitTargetCoef1 = 3.1;        //ProfitTargetCoef1
input double StopLossCoef1 = 4;        //StopLossCoef1
...
#define LINEARREGRESSION_1 3     //iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd1, PRICE_CLOSE)
#define ATR_3 4     //iCustom(NULL,0, "SqATR", ATRPeriod3)
#define ATR_4 5     //iCustom(NULL,0, "SqATR", ATRPeriod4)
#define ATR_5 6     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 5.71.164";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(CCI_1, 1)<-145.0)
      &&   (((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 2), 6))
      &&   (sqOpen("NULL",0, 3) > sqGetIndicatorValue(LINEARREGRESSION_1, 3+1)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_3, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_4, 0, 2), 6))))
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_5, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_5, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL,0, "SqATR", ATRPeriod4);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL, 0, "SqATR", 20);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef1 * sqGetIndicatorValue(ATR_5, 1)")) {
      return (ProfitTargetCoef1 * sqGetIndicatorValue(ATR_5, 1));
   }
   if(idHash == sqStringHash("StopLossCoef1 * sqGetIndicatorValue(ATR_5, 1)")) {
      return (StopLossCoef1 * sqGetIndicatorValue(ATR_5, 1));
   }
