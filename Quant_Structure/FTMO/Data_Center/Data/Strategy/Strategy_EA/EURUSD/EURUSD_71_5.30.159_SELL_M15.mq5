//+------------------------------------------------------------------+
//| Strategy 5.30.159 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/23/2026 16:04
//| 
//|    Backtested on FTMO_EURUSD_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 5.30.159";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int RSIPeriod1 = 14;        //RSIPeriod1
input int LinRegBarOpensPrd1 = 63;        //LinRegBarOpensPrd1
input int LinRegBarOpensPrd2 = 50;        //LinRegBarOpensPrd2
...
#define LINEARREGRESSION_1 1     //iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd1, PRICE_WEIGHTED)
#define LINEARREGRESSION_2 2     //iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 5.30.159";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqIsGreaterCount("sqGetIndicatorValue(RSI_1, 0, 1)","50.0",2,false,1))
      &&   ((sqOpen("NULL",0, 3) < sqGetIndicatorValue(LINEARREGRESSION_1, 3+1))
      &&   (sqOpen("NULL",0, 3) < sqGetIndicatorValue(LINEARREGRESSION_2, 3+1))))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd1, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_2] = iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd2, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(RSI_1, 0, 1)") {
          return sqGetIndicatorValue(RSI_1, 0, shift + 1);
      }
      if(id == "50.0") {
          return   50.0;
      }
