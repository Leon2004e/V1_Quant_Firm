//+------------------------------------------------------------------+
//| Strategy 2.34.129 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/18/2026 08:59
//| 
//|    Backtested on FTMO_EURUSD_M15 / M15,H8, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_34_129";
...
input int HullMovingAvrPrd1 = 20;        //HullMovingAvrPrd1
input int LWMAPeriod1 = 30;        //LWMAPeriod1
input int MABarClosesPeriod1 = 14;        //MABarClosesPeriod1
input double PriceEntryMult1 = 1.4;        //PriceEntryMult1
input double ProfitTargetCoef1 = 3.6;        //ProfitTargetCoef1
input double StopLossCoef1 = 5.6;        //StopLossCoef1
input int LWMAPeriod2 = 40;        //LWMAPeriod2
...
input int Subchart1Timeframe = 480;
...
#define LWMA_1 1     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), LWMAPeriod1, 0, MODE_LWMA, PRICE_LOW)
#define MOVINGAVERAGE_1 2     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_EMA, PRICE_TYPICAL)
#define LWMA_2 3     //iMA(NULL,0, LWMAPeriod2, 0, MODE_LWMA, PRICE_MEDIAN)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_2 5     //iCustom(NULL, 0, "SqATR", 30)
...
string sqStrategyName = "Strategy 2.34.129";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(LWMA_1, 0, 2), 6))
      &&   (sqClose("NULL",0, 3) > sqGetIndicatorValue(MOVINGAVERAGE_1, 3)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Limit
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LWMA_2, 0, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");     
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_LIMIT, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_LIMIT, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), LWMAPeriod1, 0, MODE_LWMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_EMA, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_2] = iMA(NULL,0, LWMAPeriod2, 0, MODE_LWMA, PRICE_MEDIAN);
