...
//|    Generated at 12/13/2025 12:14
//| 
//|    Backtested on FTMO_EURUSD_M15 / M15,H1,H4, 2021.07.13 - 2024.05.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.6.111";
...
input double TrailingStopCoef1 = 3.8;        //TrailingStopCoef1
...
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 140)
...
string sqStrategyName = "Strategy 6.6.111";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) (sqGetIndicatorValue(EMA_1, 0, 1) + (sqGetIndicatorValue(ATR_1, 0, 1) * 1.65)), 6))
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 19.0)
)
   {
      // Action #1
        // Enter at Market
