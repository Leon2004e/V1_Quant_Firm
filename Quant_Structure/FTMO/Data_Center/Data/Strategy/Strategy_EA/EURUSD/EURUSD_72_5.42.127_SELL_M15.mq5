...
input string CustomComment = "Strategy 5.42.127";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 10;        //EMAPeriod1
input int EMAPeriod2 = 50;        //EMAPeriod2
input int OSMAChangesFastEMA1 = 3;        //OSMAChangesFastEMA1
input int OSMAChangesSlowEMA1 = 52;        //OSMAChangesSlowEMA1
input int OSMAChangesSgnPrd1 = 15;        //OSMAChangesSgnPrd1
input double ProfitTargetCoef1 = 3;        //ProfitTargetCoef1
...
#define OSMA_1 2     //iOsMA(NULL,0, OSMAChangesFastEMA1, OSMAChangesSlowEMA1, OSMAChangesSgnPrd1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 5.42.127";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) sqClose(NULL,0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 2), 6))
      &&   (NormalizeDouble((double) sqHigh(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 1), 6)))
      &&   changesDown(OSMA_1, 2, 0))
)
   {
      // Action #1
        // Enter at Market
