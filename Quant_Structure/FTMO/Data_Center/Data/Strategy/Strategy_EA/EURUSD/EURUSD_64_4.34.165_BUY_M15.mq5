...
input string CustomComment = "Strategy 4.34.165";
...
input int GannHiLoPeriod1 = 12;        //GannHiLoPeriod1
...
#define HULLMOVINGAVERAGE_1 1     //iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_HIGH)
#define GANNHILO_1 2     //iCustom(NULL,0,"SqGannHiLo",GannHiLoPeriod1)
...
string sqStrategyName = "Strategy 4.34.165";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(GANNHILO_1, 0, 2), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HULLMOVINGAVERAGE_1] = iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[GANNHILO_1] = iCustom(NULL,0,"SqGannHiLo",GannHiLoPeriod1);
