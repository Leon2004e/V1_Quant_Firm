...
input string CustomComment = "Strategy 6.10.164";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int QQEVle1CrsVle2RSIPrd1 = 117;        //QQEVle1CrsVle2RSIPrd1
input int QQEValue1CrsVle2sF1 = 5;        //QQEValue1CrsVle2sF1
input double ProfitTargetCoef1 = 5.4;        //ProfitTargetCoef1
input double StopLossCoef1 = 3.9;        //StopLossCoef1
...
#define QQE_1 1     //iCustom(NULL,0, "SqQQE", QQEVle1CrsVle2RSIPrd1, QQEValue1CrsVle2sF1, 2.586, 0)
...
string sqStrategyName = "Strategy 6.10.164";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(CCI_1, 1)>159.0)
      &&   (sqGetIndicatorValue(QQE_1, 0, 1 + 1, true) < sqGetIndicatorValue(QQE_1, 1, 1 + 1, true) &&sqGetIndicatorValue(QQE_1, 0, 1, true) > sqGetIndicatorValue(QQE_1, 1, 1, true)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[QQE_1] = iCustom(NULL,0, "SqQQE", QQEVle1CrsVle2RSIPrd1, QQEValue1CrsVle2sF1, 2.586, 0);
