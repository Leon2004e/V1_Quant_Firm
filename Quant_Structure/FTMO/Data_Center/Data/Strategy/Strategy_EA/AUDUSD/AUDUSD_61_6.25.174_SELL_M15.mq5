...
input string CustomComment = "Strategy 6.25.174";
...
input int ATRPeriod2 = 171;        //ATRPeriod2
input int DIPeriod1 = 14;        //DIPeriod1
input double ProfitTargetCoef1 = 1.9;        //ProfitTargetCoef1
...
#define ADX_1 3     //iCustom(NULL,0, "SqADX", DIPeriod1)
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 15)
#define ATR_4 5     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 6.25.174";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(RSI_1, 1)>60)
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 2), 6))
      &&   changesDown(ADX_1, 3, 2)))
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", DIPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 15);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 20);
