...
//|    Generated at 11/13/2025 12:12
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15,H1, 2021.07.13 - 2025.11.07 
//+------------------------------------------------------------------+
...
string sqStrategyName = "Strategy 3.2.189";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (crossesDown(RSI_1, 1, 35)
      &&   sqGetIndicatorValue(ADX_1, 0, 1) > 16)
)
   {
      // Action #1
        // Enter at Market
