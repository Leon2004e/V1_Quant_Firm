//+------------------------------------------------------------------+
//| Strategy 2.34.141 EA
//|
//|    Generated by StrategyQuant X Build 142 for AlgoCloud
//|    Generated at 12/03/2025 12:04
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15,H1,H4, 2021.07.13 - 2024.12.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 2.34.141";
...
input double ProfitTargetCoef1 = 3.4;        //ProfitTargetCoef1
...
#define LOWESTINRANGE_1 0     //iCustom(NULL,0, "SqLowestInRange", "2:55", "6:00")
...
string sqStrategyName = "Strategy 2.34.141";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (indyCrossesBelow("sqClose(NULL,0, 1)", LOWESTINRANGE_1, 0, 1, 0, 0)
...
bool initIndicators(){
   ...
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "2:55", "6:00");
