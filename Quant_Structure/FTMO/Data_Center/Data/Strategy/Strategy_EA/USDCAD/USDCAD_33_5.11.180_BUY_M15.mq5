//+------------------------------------------------------------------+
//| Strategy 5.11.180 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 10/08/2025 12:41
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15,H1,H4, 2021.07.14 - 2025.10.07 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 5.11.180";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 52;        //EMAPeriod1
input int EMAPeriod2 = 92;        //EMAPeriod2
input int BollingerBandsPrd1 = 21;        //BollingerBandsPrd1
input int ATRLowerPeriod1 = 14;        //ATRLowerPeriod1
input double ProfitTarget1 = 185;        //ProfitTarget1
...
input double Subchart2TickSizeSQ = 1.0E-4; //Subchart2PipSizeSQ
...
#define EMA_1 0     //iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define EMA_2 1     //iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE)
#define ATR_1 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRLowerPeriod1)
...
string sqStrategyName = "Strategy 5.11.180";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqGetIndicatorValue(ATR_1, 1) < 0.0015)
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   indicatorHandles[EMA_1] = iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_2] = iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRLowerPeriod1);
