...
input string CustomComment = "Strategy 4.16.175";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 11111;        //MagicNumber
input int BollingerBandsPrd1 = 18;        //BollingerBandsPrd1
input int ADXHigherPeriod1 = 16;        //ADXHigherPeriod1
...
string sqStrategyName = "Strategy 4.16.175";
