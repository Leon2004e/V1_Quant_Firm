//+------------------------------------------------------------------+
//| Strategy 3.51.113 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/24/2026 16:45
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.51.113";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int CloseVWAPVWAPPeriod1 = 194;        //CloseVWAPVWAPPeriod1
input int SMMAPeriod1 = 14;        //SMMAPeriod1
input int LinearRegressionPrd1 = 30;        //LinearRegressionPrd1
input int SMMAPeriod2 = 40;        //SMMAPeriod2
input int SMMAPeriod3 = 50;        //SMMAPeriod3
...
#define VWAP_1 1     //iCustom(NULL,0, "SqVWAP", CloseVWAPVWAPPeriod1)
...
#define SMMA_2 4     //iMA(NULL,0, SMMAPeriod2, 0, MODE_SMMA, PRICE_CLOSE)
#define SMMA_3 5     //iMA(NULL,0, SMMAPeriod3, 0, MODE_SMMA, PRICE_HIGH)
#define ATR_1 6     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 3.51.113";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(CCI_1, 0, 1), 6) >= NormalizeDouble((double) 121.0, 6))
      &&   (((sqClose("NULL",0, 1) > sqGetIndicatorValue(VWAP_1,1))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMMA_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 3), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(SMMA_2, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(SMMA_3, 0, 3), 6))))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[VWAP_1] = iCustom(NULL,0, "SqVWAP", CloseVWAPVWAPPeriod1);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_3] = iMA(NULL,0, SMMAPeriod3, 0, MODE_SMMA, PRICE_HIGH);
