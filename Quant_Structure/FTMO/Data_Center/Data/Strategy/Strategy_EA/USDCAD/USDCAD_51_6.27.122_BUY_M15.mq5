//+------------------------------------------------------------------+
//| Strategy 6.27.122 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 03/14/2026 14:21
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15,H4, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_6_27_122";
...
input int OSMAChangesFastEMA1 = 24;        //OSMAChangesFastEMA1
input int OSMAChangesSlowEMA1 = 10;        //OSMAChangesSlowEMA1
input int OSMAChangesSgnPrd1 = 16;        //OSMAChangesSgnPrd1
input int MTATRPeriod1 = 130;        //MTATRPeriod1
input int WoodiesZLRPeriod1 = 14;        //WoodiesZLRPeriod1
input int OSMAChangesFastEMA2 = 3;        //OSMAChangesFastEMA2
input int OSMAChangesSlowEMA2 = 146;        //OSMAChangesSlowEMA2
input int OSMAChangesSgnPrd2 = 138;        //OSMAChangesSgnPrd2
input int MTATRPeriod2 = 15;        //MTATRPeriod2
input int OSMAChangesSgnPrd3 = 106;        //OSMAChangesSgnPrd3
input double ProfitTargetCoef1 = 4.1;        //ProfitTargetCoef1
input double StopLoss1 = 40;        //StopLoss1
input double ProfitTargetCoef2 = 7.3;        //ProfitTargetCoef2
...
#define OSMA_1 0     //iOsMA(NULL,0, OSMAChangesFastEMA1, OSMAChangesSlowEMA1, OSMAChangesSgnPrd1, PRICE_CLOSE)
#define MTATR_1 1     //iATR(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MTATRPeriod1)
#define TRUERANGE_1 2     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqTrueRange");
#define CCI_1 3     //iCustom(NULL,0, "SqCCI", WoodiesZLRPeriod1, PRICE_CLOSE)
#define OSMA_2 4     //iOsMA(NULL,0, OSMAChangesFastEMA2, OSMAChangesSlowEMA2, OSMAChangesSgnPrd2, PRICE_CLOSE)
#define MTATR_2 5     //iATR(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MTATRPeriod2)
#define OSMA_3 6     //iOsMA(NULL,0, OSMAChangesFastEMA1, OSMAChangesSlowEMA1, OSMAChangesSgnPrd3, PRICE_CLOSE)
#define ATR_1 7     //iCustom(NULL, 0, "SqATR", 20)
#define ATR_2 8     //iCustom(NULL, 0, "SqATR", 30)
...
string sqStrategyName = "Strategy 6.27.122";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesUp(OSMA_1, 1, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(MTATR_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(TRUERANGE_1, 0, 3), 6)));

     ShortEntrySignal = (((((sqGetIndicatorValue(CCI_1,2) < 0)&& (sqGetIndicatorValue(CCI_1,2+1) < 0)&& (sqGetIndicatorValue(CCI_1,2+2) < 0)&& (sqGetIndicatorValue(CCI_1,2+3) < 0)&& (sqGetIndicatorValue(CCI_1,2+4) < 0)&& (sqGetIndicatorValue(CCI_1,2+5) < 0))&& (sqGetIndicatorValue(CCI_1,2) < sqGetIndicatorValue(CCI_1,2+1))&& (sqGetIndicatorValue(CCI_1,2+2) < sqGetIndicatorValue(CCI_1,2+1))&& ((sqGetIndicatorValue(CCI_1,2+1) - sqGetIndicatorValue(CCI_1,2))>10)&& ((sqGetIndicatorValue(CCI_1,2+1) - sqGetIndicatorValue(CCI_1,2+2))>10)&& (sqGetIndicatorValue(CCI_1,2) < 100)&& (sqGetIndicatorValue(CCI_1,2+1) < 100)&& (sqGetIndicatorValue(CCI_1,2+2) < 100)&& (sqGetIndicatorValue(CCI_1,2) > -100)&& (sqGetIndicatorValue(CCI_1,2+1) > -100)&& (sqGetIndicatorValue(CCI_1,2+2) > -100)
      &&   changesUp(OSMA_2, 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(MTATR_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(TRUERANGE_1, 0, 1), 6)))
      &&   changesUp(OSMA_3, 3, 0));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MTATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TRUERANGE_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqTrueRange");;
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[CCI_1] = iCustom(NULL,0, "SqCCI", WoodiesZLRPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[OSMA_2] = iOsMA(NULL,0, OSMAChangesFastEMA2, OSMAChangesSlowEMA2, OSMAChangesSgnPrd2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_2] = iATR(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MTATRPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[OSMA_3] = iOsMA(NULL,0, OSMAChangesFastEMA1, OSMAChangesSlowEMA1, OSMAChangesSgnPrd3, PRICE_CLOSE);
